...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-behavior-flutter/security/advisories/new).
...
This policy covers the `synheart_behavior` SDK published from this repository. Issues
